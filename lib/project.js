 ...
 * @api public
 */
// TODO: Moved to phases/apply, can be deleted once fully refactored.
...
Project.prototype.boot = function(file, env, options, cb) {
  return;
  // FIXME: Old code below this, can be removed once ported to applier.
  ...
  // TODO: Remove this.  Factored out to cli/apply (should possibly be a phase?)
