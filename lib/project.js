 ...
 * @api private
 */
Project.prototype.init = function(env) {
  env = env || process.env.NODE_ENV || 'development';
  
  this.env = env;
  
  // TODO: Clean this up.  Introduce an "Applier" class, and pass it
  //       a project.
  var context = new Context();
  context.defaults();
  
  this._hostsLoader = context.hostsLoader;
  
  this.phase(require('./boot/hosts')(this));
};
 ...
 * @api public
 */
Project.prototype.host = 
Project.prototype.system = function(url, options) {
 ...
 * @api public
 */
Project.prototype.role = function(name) {
 ...
 * @api public
 */
Project.prototype.get =
Project.prototype.set = function(setting, val) {
 ...
 * @api public
 */
Project.prototype.enabled = function(setting) {
 ...
 * @api public
 */
Project.prototype.disabled = function(setting) {
  return !this.set(setting);
}
 ...
 * @api public
 */
Project.prototype.enable = function(setting) {
 ...
 * @api public
 */
Project.prototype.disable = function(setting) {
 ...
 * @api public
 */
Project.prototype.apply = function(criteria, options, cb) {
  criteria = criteria || ['*'];
  options = options || {};
  cb = cb || function(){};
 ...
 * @api public
 */
Project.prototype.detect = function(fn, conn, cb) {
...
Project.prototype.component = function(name) {
 ...
 * @api public
 */
Project.prototype.render = function(name, options, cb) {
...
Project.prototype.phase = function(fn) {
 ...
 * @api public
 */
Project.prototype.boot = function(file, env, options, cb) {
  ...
  if (!existsSync(file)) { return cb(new Error('plan does not exist: ' + file)); }
  ...
  // FIXME: Old code below this, can be removed once ported to bootable.
